export const PERMISSIONS = {
  ...
  ASSIGNMENT_CHECKLIST_VIEW: 'ASSIGNMENT_CHECKLIST_VIEW',
  ASSIGNMENT_CHECKLIST_UPDATE: 'ASSIGNMENT_CHECKLIST_UPDATE',
  ASSIGNMENT_CHECKLIST_PROOF_UPLOAD: 'ASSIGNMENT_CHECKLIST_PROOF_UPLOAD',
  ASSIGNMENT_CHECKLIST_PROOF_DELETE: 'ASSIGNMENT_CHECKLIST_PROOF_DELETE',
  ASSIGNMENT_WORK_LOG_VIEW: 'ASSIGNMENT_WORK_LOG_VIEW',
  ASSIGNMENT_WORK_LOG_CREATE: 'ASSIGNMENT_WORK_LOG_CREATE',
  ASSIGNMENT_WORK_LOG_UPDATE: 'ASSIGNMENT_WORK_LOG_UPDATE',
  ASSIGNMENT_WORK_LOG_DELETE: 'ASSIGNMENT_WORK_LOG_DELETE',
  ASSIGNMENT_WORK_LOG_ATTACHMENT_UPLOAD: 'ASSIGNMENT_WORK_LOG_ATTACHMENT_UPLOAD',
  ASSIGNMENT_WORK_LOG_ATTACHMENT_DELETE: 'ASSIGNMENT_WORK_LOG_ATTACHMENT_DELETE',
  DOWNTIME_VIEW: 'DOWNTIME_VIEW',
  DOWNTIME_CREATE: 'DOWNTIME_CREATE',
  ...
  SPARE_USAGE_VIEW: 'SPARE_USAGE_VIEW',
  SPARE_USAGE_CREATE: 'SPARE_USAGE_CREATE',
  SPARE_USAGE_UPDATE: 'SPARE_USAGE_UPDATE',
  SPARE_USAGE_DELETE: 'SPARE_USAGE_DELETE',
  ...
  SPARE_USAGE_REJECT: 'SPARE_USAGE_REJECT',
  SPARE_USAGE_CANCEL: 'SPARE_USAGE_CANCEL',
  SPARE_USAGE_RETURN: 'SPARE_USAGE_RETURN',
