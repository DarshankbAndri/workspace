export const PERMISSIONS = {
  ...
  VENDOR_AMC_VIEW: 'VENDOR_AMC_VIEW',
  VENDOR_AMC_CREATE: 'VENDOR_AMC_CREATE',
  VENDOR_AMC_UPDATE: 'VENDOR_AMC_UPDATE',
  VENDOR_AMC_DELETE: 'VENDOR_AMC_DELETE',
  VENDOR_AMC_ASSIGN_EQUIPMENT: 'VENDOR_AMC_ASSIGN_EQUIPMENT',
  VENDOR_AMC_RENEW: 'VENDOR_AMC_RENEW',
