...
public class EquipmentDowntimeDAO {
    ...
    public long countOverlappingActiveDowntime(Long equipmentId, Long excludeId, LocalDateTime start, LocalDateTime end) { return repository.countOverlappingActiveDowntime(equipmentId, excludeId, start, end); }
