...
public interface ApprovalRequestRepository extends JpaRepository<ApprovalRequest, Long>, JpaSpecificationExecutor<ApprovalRequest> {
    ...
    long countByApprovalStatusAndRequestedAtBefore(String approvalStatus, Instant requestedAt);
    long countByModuleCodeAndApprovalStatusAndRequestedAtBefore(String moduleCode, String approvalStatus, Instant requestedAt);
}
